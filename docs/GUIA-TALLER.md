...
También podés escribir `/modificar-agente`. Primero va a mirar qué hace tu agente hoy, después te preguntará solamente por el cambio, te dirá qué se conserva y lo probará sin empezar de cero.
