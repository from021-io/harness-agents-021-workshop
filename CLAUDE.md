...
- El servidor carga el `.env` al arrancar: después de tocar credenciales hay que reiniciarlo (`npm run dev`) o el agente va a actuar como si no existieran. Reiniciar también invalida los botones de Telegram ya enviados, otro motivo para no usarlos.
