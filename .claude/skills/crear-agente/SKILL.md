---
name: crear-agente
description: Flujo completo del taller para crear un agente personal. Descubre el producto con la skill genérica, selecciona el adaptador necesario, construye y personaliza el template, y lo prueba en vivo. Usar cuando el usuario escribe /crear-agente o dice que quiere crear o empezar su agente.
---
...
4. **La conversación de descubrimiento**: seguí `.claude/skills/descubrir-producto/SKILL.md` en modo creación. Para este taller, presentá los tres productos disponibles por su beneficio: agenda, noticias y herramienta interna. Después de la elección, cargá únicamente la referencia correspondiente. Salida: `mi-agente/PRODUCTO.md`.
...
- Si `mi-agente/PRODUCTO.md` ya existe, ofrecé retomar, modificar con `/modificar-agente` o empezar de nuevo. No borres nada sin una elección explícita.
