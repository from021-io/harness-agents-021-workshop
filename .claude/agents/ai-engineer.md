...
3. **Personalizá** con el brief:
   ...
   - Agenda: ajustá el cron de `agent/schedules/digest_agenda.ts` al horario pedido (¡convertí a UTC!), y `data/backlog.md` con 2-3 tareas reales que la persona haya mencionado (dejá el formato de ejemplo).
